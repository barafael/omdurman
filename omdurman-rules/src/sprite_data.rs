...
pub fn sprite_data_for(section: omdurman_types::SectionName, col: u8, row: u8) -> Option<SpriteData> {
    match (section, col, row) {
        (omdurman_types::SectionName::BritishBoats, 3, 1) => Some(SpriteData {
            ...
            kind: Some(::omdurman_types::UnitKind::Infantry { fire: 0, melee: 0, movement: 0 }),
        ...
        (omdurman_types::SectionName::AliWadHelu, 0, 1) => Some(SpriteData {
            faction: Some(::omdurman_types::Faction::Dervish { tribe: ::omdurman_types::DervishTribe::Kehena }),
        ...
        (omdurman_types::SectionName::Baggara, 0, 0) => Some(SpriteData {
            faction: Some(::omdurman_types::Faction::Dervish { tribe: ::omdurman_types::DervishTribe::Baggara }),
            kind: Some(::omdurman_types::UnitKind::Infantry { fire: 3, melee: 6, movement: 15 }),
        ...
        (omdurman_types::SectionName::BritishBoats, 4, 1) => Some(SpriteData {
            faction: Some(::omdurman_types::Faction::BritishEgyptian { brigade: None }),
            kind: Some(::omdurman_types::UnitKind::Gunboat { fire: 4, upstream: 10, downstream: 16 }),
            color: SpriteColor::SandBlack,
            text: "Gunboat",
        }),
        ...
        (omdurman_types::SectionName::BritishArmy, 0, 0) => Some(SpriteData {
            faction: Some(::omdurman_types::Faction::BritishEgyptian { brigade: None }),
            kind: Some(::omdurman_types::UnitKind::Infantry { fire: 8, melee: 5, movement: 15 }),
            color: SpriteColor::SandBlack,
            text: "21 Lancers",
        }),
        (omdurman_types::SectionName::BritishArmy, 0, 1) => Some(SpriteData {
            faction: Some(::omdurman_types::Faction::BritishEgyptian { brigade: None }),
            kind: Some(::omdurman_types::UnitKind::Infantry { fire: 10, melee: 5, movement: 8 }),
            color: SpriteColor::SandBlack,
            text: "Cameron II.",
        }),
        (omdurman_types::SectionName::BritishArmy, 1, 0) => Some(SpriteData {
            faction: Some(::omdurman_types::Faction::BritishEgyptian { brigade: None }),
            kind: Some(::omdurman_types::UnitKind::Infantry { fire: 5, melee: 3, movement: 8 }),
            color: SpriteColor::SandBlack,
            text: "Royal Eng.",
        }),
        ...
        (omdurman_types::SectionName::BritishArmy, 2, 0) => Some(SpriteData {
            faction: Some(::omdurman_types::Faction::BritishEgyptian { brigade: None }),
            kind: Some(::omdurman_types::UnitKind::Infantry { fire: 10, melee: 1, movement: 7 }),
            color: SpriteColor::SandBlack,
            text: "32 Battery",
        }),
        ...
        (omdurman_types::SectionName::BritishArmy, 4, 0) => Some(SpriteData {
            faction: Some(::omdurman_types::Faction::BritishEgyptian { brigade: None }),
            kind: Some(::omdurman_types::UnitKind::Infantry { fire: 6, melee: 1, movement: 12 }),
            color: SpriteColor::SandBlack,
            text: "Maxim Batt.",
        }),
        ...
        (omdurman_types::SectionName::EgyptianArmy, 0, 0) => Some(SpriteData {
            faction: Some(::omdurman_types::Faction::BritishEgyptian { brigade: None }),
            kind: Some(::omdurman_types::UnitKind::Infantry { fire: 10, melee: 5, movement: 15 }),
            color: SpriteColor::WhiteSand,
            text: "Egy. Cav.",
        }),
        (omdurman_types::SectionName::EgyptianArmy, 0, 1) => Some(SpriteData {
            faction: Some(::omdurman_types::Faction::BritishEgyptian { brigade: None }),
            kind: Some(::omdurman_types::UnitKind::Infantry { fire: 9, melee: 5, movement: 8 }),
            color: SpriteColor::WhiteSand,
            text: "III Egy.",
        }),
        ...
        (omdurman_types::SectionName::EgyptianArmy, 3, 0) => Some(SpriteData {
            faction: Some(::omdurman_types::Faction::BritishEgyptian { brigade: None }),
            kind: Some(::omdurman_types::UnitKind::Infantry { fire: 8, melee: 1, movement: 7 }),
            color: SpriteColor::WhiteSand,
            text: "Egy. Batt.",
        }),
        ...
        (omdurman_types::SectionName::Hadendowa, 0, 0) => Some(SpriteData {
            faction: Some(::omdurman_types::Faction::Dervish { tribe: ::omdurman_types::DervishTribe::IsaZachneih }),
        ...
        (omdurman_types::SectionName::Hadendowa, 0, 1) => Some(SpriteData {
            ...
            kind: Some(::omdurman_types::UnitKind::Infantry { fire: 3, melee: 7, movement: 9 }),
            color: SpriteColor::WhiteBlack,
            text: "Hadendowa",
        }),
        ...
        (omdurman_types::SectionName::KhalifaAbdullah, 0, 1) => Some(SpriteData {
            faction: Some(::omdurman_types::Faction::Dervish { tribe: ::omdurman_types::DervishTribe::Baggara }),
            kind: Some(::omdurman_types::UnitKind::Infantry { fire: 6, melee: 1, movement: 7 }),
            color: SpriteColor::BlackWhite,
            text: "",
        }),
        ...
        (omdurman_types::SectionName::Kitchener, 0, 0) => Some(SpriteData {
            faction: Some(::omdurman_types::Faction::BritishEgyptian { brigade: None }),
            kind: Some(::omdurman_types::UnitKind::Infantry { fire: 0, melee: 0, movement: 15 }),
            color: SpriteColor::SandBlack,
        ...
        (omdurman_types::SectionName::Kitchener, 3, 0) => Some(SpriteData {
            faction: Some(::omdurman_types::Faction::BritishEgyptian { brigade: None }),
            kind: Some(::omdurman_types::UnitKind::Infantry { fire: 8, melee: 5, movement: 12 }),
        ...
        (omdurman_types::SectionName::Sherif, 0, 0) => Some(SpriteData {
            faction: Some(::omdurman_types::Faction::Dervish { tribe: ::omdurman_types::DervishTribe::Danagla }),
            kind: Some(::omdurman_types::UnitKind::Infantry { fire: 1, melee: 1, movement: 15 }),
        ...
        (omdurman_types::SectionName::Sherif, 1, 0) => Some(SpriteData {
            faction: Some(::omdurman_types::Faction::Dervish { tribe: ::omdurman_types::DervishTribe::Danagla }),
            kind: Some(::omdurman_types::UnitKind::Infantry { fire: 4, melee: 6, movement: 12 }),
            color: SpriteColor::RedBlack,
            text: "",
        }),
        ...
        (omdurman_types::SectionName::Taiasha, 0, 0) => Some(SpriteData {
            faction: Some(::omdurman_types::Faction::Dervish { tribe: ::omdurman_types::DervishTribe::Taiasha }),
            kind: Some(::omdurman_types::UnitKind::Infantry { fire: 3, melee: 6, movement: 9 }),
            color: SpriteColor::BlackWhite,
            text: "Taiasha",
        }),
