...
12. **Advance-after-combat is restricted.** Only units that took part and were
    adjacent may advance; artillery may never advance; never across a wall
    hexside (except a gate or breach) or across a khor (§6.82). A breach or a
    gate is a strategic corridor — hold it or close it.
    — §6.82, §6.63

## Zones of control

13. **ZOC stops movement cold.** A unit must stop immediately when it enters an
...
14. **ZOC terrain gaps are real.** ZOCs do not extend across a khor, into a
...
15. **Disrupted units exert no ZOC.** A disrupted unit has no ZOC (§5.41), so a
...
16. **Four combat units per hex, leaders free.** Max four units per hex except
...
17. **Dervish tribes never mix; AE brigades must.** Dervish units of different
...
18. **Terrain costs are per hex entered, roads cheapen clear/rough/trees.**
...
19. **Gunboats: upstream vs downstream.** A gunboat's two allowances are
...
20. **MP don't carry over.** Unused movement points are lost at the end of the
...
21. **Night halves AE movement, halves ranges, bans howitzer.** At night:
...
22. **AE leaders die alone.** An Anglo-Egyptian leader is eliminated if alone in
...
23. **VP are asymmetric — play to your table.** The AE scores the Mahdi's Tomb
